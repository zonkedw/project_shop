...
ФОРМАТ ОТВЕТА:
- Короткое интро 1-2 предложения
- 3-6 буллетов с конкретными цифрами/шагами/продуктами/упражнениями
- Итог: что сделать дальше или главный вывод
- Пиши по делу, избегай воды
